        ...
        >
          ...
          >
            ...
            <button
              onClick={() => {
                alert(
                  'Running local rule categorization engine...'
                );
              }}
              style={{
                display: 'inline-flex',
                ...
                fontSize: 14,
                boxShadow:
                  '0 4px 14px rgba(129, 140, 248, 0.15)',
                transition: 'all 0.2s ease',
              }}
            >
              <span>
            ...
            <button
              ...
              style={{
                ...
                fontSize: 14,
                boxShadow:
                  '0 4px 14px rgba(248, 113, 113, 0.1)',
                transition: 'all 0.2s ease',
              }}
            >
              <span>Sign Out</span>
        ...
        >
          ...
          <div
            style={{
              ...
              border:
                '1px solid rgba(56, 189, 248, 0.3)',
              backgroundImage:
                'linear-gradient(135deg, rgba(56, 189, 248, 0.08) 0%, rgba(15, 23, 42, 0) 100%)',
              boxShadow:
          ...
          <div
            style={{
              ...
              backgroundImage:
                'linear-gradient(135deg, rgba(129, 140, 248, 0.08) 0%, rgba(15, 23, 42, 0) 100%)',
              boxShadow:
                '0 8px 24px rgba(0, 0, 0, 0.3)',
            }}
          >
